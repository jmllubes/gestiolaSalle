<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>La Salle - Nueva contraseña</title>
    ...
    <body style="background-image: url('{{ asset('svg/maxresdefault.jpg') }}'); background-repeat: no-repeat; background-size: 100% 100%;">
        <div class="container">
            <div class="row justify-content-center pt-5">
                <div class="col-md-8">
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-header">{{ __('Reiniciar contrasenya') }}</div>
